...
// ============================================
// РЕЖИМЫ ИГРЫ С ВИЗУАЛЬНЫМИ ОТЛИЧИЯМИ
// ============================================
...
function playMode(modeName) {
    ...
    if (modeName === 'Классический') {
        startClassicMode();
    } else if (modeName === 'На время') {
        startTimedMode();
    } else if (modeName === 'Выживание') {
        startSurvivalMode();
    } else if (modeName === 'Блиц') {
        startBlitzMode();
    }
}
...
function startClassicMode() {
    ...
    infoDiv.innerHTML = `
        <div class="info-item">
            <div style="font-size: 12px; color: #999;">Найдено пар</div>
...
function startTimedMode() {
    ...
    infoDiv.innerHTML = `
        ...
        <div class="info-item">
            <div style="font-size: 12px; color: #999;">Осталось</div>
...
function startSurvivalMode() {
    ...
    infoDiv.innerHTML = `
        ...
        <div class="info-item">
            <div style="font-size: 12px; color: #999;">Жизни</div>
            <div style="font-size: 28px; font-weight: bold; color: #ff1744;">
                ❤️ <span id="livesCount">3</span>
            </div>
        </div>
    `;
...
function startBlitzMode() {
    ...
    infoDiv.innerHTML = `
        <div class="info-item">
            <div style="font-size: 12px; color: #999;">Найдено пар</div>
            <div style="font-size: 28px; font-weight: bold; color: #ffa500;">
                <span id="foundCount">0</span>/6
            </div>
        </div>
        <div class="info-item">
...
console.log('✅ Визуальные режимы игры загружены');
